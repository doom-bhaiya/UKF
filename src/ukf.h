...
class UKF {
 public:
  ...
  void NormalizeAngleOnComponent(Eigen::VectorXd vector, int index);

  Eigen::MatrixXd GenerateSigmaPoints(Eigen::VectorXd x, Eigen::MatrixXd P, double lambda, int n_sig);
  Eigen::MatrixXd PredictSigmaPoints(Eigen::MatrixXd Xsig, double delta_t, int n_x, int n_sig, double nu_am, double nu_yawdd);
